...
define(["service!sap.bi.da.extension.sdk.clientRequestService", "ChromeLogsExtensionDialogController"], function (ClientRequestService, ChromeLogsExtensionDialogController) {
    "use strict";

    function ChromeLogsExtension() {

        var EXTENSION_ID = "com.sap.lumira.da.chromelogsextension";
        ...
        var createChromeLogsExtensionDialog = function(acquisitionState, workflow) {
            var oDeferred = new jQuery.Deferred();
            var controller = new ChromeLogsExtensionDialogController(acquisitionState, oDeferred, fServiceCall, workflow);
        ...
        this.doCreateWorkflow = function(acquisitionState) {
            return createChromeLogsExtensionDialog(acquisitionState, "CREATE");
        };

    	// This function will be called during an edit dataset workflow
        this.doEditWorkflow = function(acquisitionState) {
            return createChromeLogsExtensionDialog(acquisitionState, "EDIT");
        };
    ...
    ChromeLogsExtension.prototype.getConnectionDescription = function(acquisitionState) {
    ...
    ChromeLogsExtension.prototype.getIcon48 = function() {
        return "/img/48.png";
    };
    ChromeLogsExtension.prototype.getIcon32 = function() {
        return "/img/32.png";
    };
    // The white version of the icon will be displayed when the extension is highlighted in the New Dataset dialog
    ChromeLogsExtension.prototype.getIcon32_white = function() {
        return "/img/32_w.png";
    };
    ChromeLogsExtension.prototype.getIcon24 = function() {
        return "/img/24.png";
    };
    ChromeLogsExtension.prototype.getIcon16 = function() {
        return "/img/16.png";
    };

    return ChromeLogsExtension;
});